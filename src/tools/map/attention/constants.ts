export const GET_ATTENTION_DESCRIPTION = [
    ...
    'on a depleted deposit (warning); revealed-but-unbuilt cells, and cells in a post-demolish rebuild cooldown',
    '(info — on a `demolish_cooldown` item `arrivalAt` marks when rebuild reopens). Items are purely descriptive (cell,',
