export const GET_CELL_DESCRIPTION = [
    ...
    '`storage` box (used/cap/reserved/stalled) and the active process a `stalled` flag — true when its warehouse',
    'is full and production is halted until you offload. For broader situational awareness use `cpu_get_map`.',
].join(' ');
