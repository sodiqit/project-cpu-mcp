export const GET_PENDING_TRANSPORTS_DESCRIPTION = [
    ...
    'automatically by a background sweep within about a minute of its deadline — just wait for it to clear;',
    'starting the same route again while it is still pending is rejected.',
].join(' ');
