...
const SERVER_INSTRUCTIONS = [
    ...
    'its signature lapses, a background sweep auto-refunds the escrow within about a minute — do not try to',
    'free it manually, and note that starting the same action again while one is still pending is rejected.',
